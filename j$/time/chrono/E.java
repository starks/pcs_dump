...
public final class E extends AbstractC0028d {
    ...
    private int b0() {
        return this.a.d0() - 1911;
    }

    private E d0(LocalDate localDate) {
    ...
    public final InterfaceC0026b p(long j, TemporalUnit temporalUnit) {
        return (E) super.p(j, temporalUnit);
    }
    ...
    public final o V() {
        return b0() >= 1 ? F.ROC : F.BEFORE_ROC;
    }
    ...
    */
    public final j$.time.chrono.E d(long r9, j$.time.temporal.n r11) {
        /*
            r8 = this;
        ...
        L9a:
            ...
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: j$.time.chrono.E.d(long, j$.time.temporal.n):j$.time.chrono.E");
    }
    ...
    public final InterfaceC0026b f(long j, TemporalUnit temporalUnit) {
        return (E) super.f(j, temporalUnit);
    }
    ...
    public final Temporal p(long j, ChronoUnit chronoUnit) {
        return (E) super.p(j, chronoUnit);
    }

    @Override // j$.time.chrono.AbstractC0028d, j$.time.temporal.Temporal
    public final Temporal y(LocalDate localDate) {
        return (E) super.y(localDate);
    }
    ...
    public final j$.time.temporal.r z(j$.time.temporal.n nVar) {
        ...
        return j$.time.temporal.r.j(1L, b0() <= 0 ? (-rVarP.e()) + 1912 : rVarP.d() - 1911);
    }
