...
public class LLMResult implements DecoratableResult, bmt {
    public static final Parcelable.Creator CREATOR = new LLMResultParcelableCreator();
    public static final Bundleable.Reader READER = new Bundleable.Reader() { // from class: com.google.android.apps.aicore.aidl.LLMResult.1
        ...
        @Override // com.google.android.apps.aicore.aidl.Bundleable.Reader
        public LLMResult readFromBundle(Bundle bundle, String str) {
            return (LLMResult) createFromBundle(bundle, str, LLMResult.CREATOR);
        }
    };
    ...
    public static LLMResult create(List list) {
        return new LLMResult(list, null);
    }
    ...
    public cxc getInferenceResultsForSafety(akm akmVar, eia eiaVar) {
        Stream map = Collection.EL.stream(getResults()).map(new Function() { // from class: com.google.android.apps.aicore.aidl.LLMResult$$ExternalSyntheticLambda0
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        LLMResultParcelableCreator.writeToParcel(this, parcel, i);
    }

    @Override // com.google.android.apps.aicore.aidl.DecoratableResult
    public LLMResult withInferenceEventTraceResult(InferenceEventTraceResult inferenceEventTraceResult) {
        return new LLMResult(this.results, inferenceEventTraceResult);
    }
}
