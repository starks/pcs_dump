...
public class TarsResult extends bmr implements DecoratableResult {
    public static final Parcelable.Creator CREATOR = new TarsResultParcelableCreator();
    public static final Bundleable.Reader READER = new Bundleable.Reader() { // from class: com.google.android.apps.aicore.aidl.TarsResult.1
        ...
        @Override // com.google.android.apps.aicore.aidl.Bundleable.Reader
        public TarsResult readFromBundle(Bundle bundle, String str) {
            return (TarsResult) createFromBundle(bundle, str, TarsResult.CREATOR);
        }
    };
    private final InferenceEventTraceResult inferenceEventTraceResult;
    private final cxc results;

    public TarsResult(List list, InferenceEventTraceResult inferenceEventTraceResult) {
        this.results = cxc.o(list);
        this.inferenceEventTraceResult = inferenceEventTraceResult;
    }

    public static TarsResult create(List list) {
        return new TarsResult(list, null);
    }
    ...
    public cxc getInferenceResultsForSafety(akm akmVar, eia eiaVar) {
        Stream map = Collection.EL.stream(getResults()).map(new Function() { // from class: com.google.android.apps.aicore.aidl.TarsResult$$ExternalSyntheticLambda0
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        TarsResultParcelableCreator.writeToParcel(this, parcel, i);
    }

    @Override // com.google.android.apps.aicore.aidl.DecoratableResult
    public TarsResult withInferenceEventTraceResult(InferenceEventTraceResult inferenceEventTraceResult) {
        return new TarsResult(this.results, inferenceEventTraceResult);
    }
}
