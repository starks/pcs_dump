...
public class QuestionToAnswerResult extends bmr implements DecoratableResult {
    public static final Parcelable.Creator CREATOR = new QuestionToAnswerResultParcelableCreator();
    public static final Bundleable.Reader READER = new Bundleable.Reader() { // from class: com.google.android.apps.aicore.aidl.QuestionToAnswerResult.1
        ...
        @Override // com.google.android.apps.aicore.aidl.Bundleable.Reader
        public QuestionToAnswerResult readFromBundle(Bundle bundle, String str) {
            return (QuestionToAnswerResult) createFromBundle(bundle, str, QuestionToAnswerResult.CREATOR);
        }
    };
    ...
    public static QuestionToAnswerResult create(List list) {
        return new QuestionToAnswerResult(cxc.o(list), null);
    }
    ...
    public cxc getInferenceResultsForSafety(akm akmVar, eia eiaVar) {
        Stream streamFlatMap = Collection.EL.stream(getResults()).flatMap(new Function() { // from class: com.google.android.apps.aicore.aidl.QuestionToAnswerResult$$ExternalSyntheticLambda0
            ...
            public final Object apply(Object obj) {
                return Stream.CC.ofNullable(((QuestionToAnswerResponse) obj).getText());
            }
