...
public class SummarizationResult extends bmr implements DecoratableResult {
    public static final Parcelable.Creator CREATOR = new SummarizationResultParcelableCreator();
    public static final Bundleable.Reader READER = new Bundleable.Reader() { // from class: com.google.android.apps.aicore.aidl.SummarizationResult.1
        ...
        @Override // com.google.android.apps.aicore.aidl.Bundleable.Reader
        public SummarizationResult readFromBundle(Bundle bundle, String str) {
            return (SummarizationResult) createFromBundle(bundle, str, SummarizationResult.CREATOR);
        }
    };
