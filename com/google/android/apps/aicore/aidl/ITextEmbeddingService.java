...
public interface ITextEmbeddingService extends IInterface {
    ...
    /* compiled from: PG */
    public abstract class Stub extends akh implements ITextEmbeddingService {
        private static final String DESCRIPTOR = "com.google.android.apps.aicore.aidl.ITextEmbeddingService";
        ...
        /* compiled from: PG */
        public class Proxy extends akg implements ITextEmbeddingService {
            ...
            @Override // com.google.android.apps.aicore.aidl.ITextEmbeddingService
            public ICancellationCallback runCancellableInference(TextEmbeddingRequest textEmbeddingRequest, ITextEmbeddingResultCallback iTextEmbeddingResultCallback) {
                Parcel parcelObtainAndWriteInterfaceToken = obtainAndWriteInterfaceToken();
                aki.b(parcelObtainAndWriteInterfaceToken, textEmbeddingRequest);
                aki.d(parcelObtainAndWriteInterfaceToken, iTextEmbeddingResultCallback);
        ...
        protected boolean dispatchTransaction(int i, Parcel parcel, Parcel parcel2, int i2) {
            if (i == 2) {
                ...
                ICancellationCallback iCancellationCallbackRunCancellableInference = runCancellableInference(textEmbeddingRequest, iTextEmbeddingResultCallbackAsInterface);
    ...
    ICancellationCallback runCancellableInference(TextEmbeddingRequest textEmbeddingRequest, ITextEmbeddingResultCallback iTextEmbeddingResultCallback);
}
