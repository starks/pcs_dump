...
public enum dcz {
    ...
    static {
        ...
        for (dcz dczVar : values()) {
            if (map.put(Character.valueOf(dczVar.G), dczVar) != null) {
                throw new IllegalStateException("duplicate format character: ".concat(String.valueOf(String.valueOf(dczVar))));
            }
        }
